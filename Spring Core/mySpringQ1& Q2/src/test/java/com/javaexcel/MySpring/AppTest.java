package com.javaexcel.MySpring;
...
class AppTest {
    ...
    @Test
    void testApp() {
        String exp[] = {"Customer customerId=10, customerName=Sourabh, customerContact=9564799157, customerAddress=Address street=Kangra, state=Himachal, zip=176508 country=India",
