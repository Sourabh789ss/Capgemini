...
public class Assignment3Q9 {
    public static void main(String[] args) {
        ...
        SavingAccount act1 = new SavingAccount(1500,15,"Chandler",true);
        SavingAccount act2 = new SavingAccount(1100,14,"Ross",true);
        SavingAccount act3 = new SavingAccount(1100,7,"Paule",true);
        SavingAccount act4 = new SavingAccount(1200,10,"wesly",true);
        SavingAccount act5 = new SavingAccount(1670,3,"Lisa",true);
        SavingAccount act6 = new SavingAccount(1000,27,"Raechal",true);
        SavingAccount act7 = new SavingAccount(1005,19,"Monica",true);
        SavingAccount act8 = new SavingAccount(1000,51,"Gunther",true);
        BankAccountList li = new BankAccountList();
        li.addSavingAccount(act1);
        li.addSavingAccount(act2);
        li.addSavingAccount(act3);
        li.addSavingAccount(act4);
        li.addSavingAccount(act5);
        li.addSavingAccount(act6);
        li.addSavingAccount(act7);
        li.addSavingAccount(act8);
